...
interface CashbookEntry {
  ...
  created_at: string
  party_id: number
  party_name: string // We'll store the party name here after joining with accounts_master
  remarks: string
  amount: number
    ...
    try {
      ...
      data?.forEach(entry => {
        ...
        entriesByDate[date].push({
          ...entry,
          party_name: entry.accounts_master ? entry.accounts_master.name : 'Unknown'
        })
      })
  ...
  return (
    <>
      ...
      <Card>
        ...
        <CardContent>
          <Button asChild>
            <Link to="/add-entry">Add New Entry
